...
# helm upgrade --install my-app ./helm/django-app --dry-run | grep DATABASE_URL
...
{{- define "django.postgresql.url" -}}
    {{- if .Values.postgresql.enabled -}}
        postgres://{{ .Values.postgresql.postgresqlUsername }}:{{ .Values.postgresql.postgresqlPassword }}@{{- template "django.postgresql.fullname" . -}}/{{ .Values.postgresql.postgresqlDatabase }}
    {{- end -}}
{{- end -}}
